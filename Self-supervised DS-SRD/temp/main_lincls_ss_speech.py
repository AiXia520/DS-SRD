...
parser.add_argument('--istrans', action='store_true',default=True,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        if os.path.isfile(args.pretrained):
            ...
            # assert set(msg.missing_keys) == {"fc2.weight", "fc2.bias"}, set(msg.missing_keys)
    ...
    if not args.finetune:
        assert len(parameters) == 4, len(parameters) # fc.weight, fc.bias
...
def sanity_check(state_dict, pretrained_weights):
    ...
    for k in list(state_dict.keys()):
        ...
        if 'fc2.weight' in k or 'fc2.bias' or 'fc.weight' in k or 'fc.bias' in k:
            continue
