...
from dataset.cifar100_pcl2 import get_cifar100_dataloaders, get_cifar100_dataloaders_sample
...
from helper.loops2 import train_distill_pcl as train, validate
...
def main():
    ...
    model_ss = model_dict[opt.model_s](num_classes=n_cls)
    ...
    module_list.append(model_ss)

    trainable_list = nn.ModuleList([])
    trainable_list.append(model_s)
    trainable_list.append(model_ss)
