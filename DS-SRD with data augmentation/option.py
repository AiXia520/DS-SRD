...
parser.add_argument('--fix_student', action='store_true', default=True)
...
parser.add_argument('--mix_n_run', type=int, default=2)
...
parser.add_argument('--cutmix_pick_criterion', type=str, default='student_entropy')
...
parser.add_argument('--t_output_as_target_for_input_mix', default=True, action='store_true')
...
parser.add_argument('--utils.ON', action='store_true', default=True)
parser.add_argument('--utils.check_ce_var', action='store_true', default= True)
